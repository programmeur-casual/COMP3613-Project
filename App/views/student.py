...
from App.controllers import (
    ...
    calculate_review_points,create_job_recommendation,create_school_recommendation)
...
def request_recommendation():
    ...
    if recommendation_type == 'Job':
        ...
        details= request.form.get('details')
        # Handle job recommendation
        newrec= create_school_recommendation(student_id, staff.ID, approved, status,
                                             cyos, details,school_name, program, school_email)
        message = f"You have submitted a recommendation request to {teacherName} !!"
